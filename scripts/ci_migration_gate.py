...
def main() -> None:
    ...
    run(
        [
            ...
            "tests/test_scheduler_config_service.py",
            "tests/test_run_managed_scheduler_script.py",
            "tests/test_send_login_expiry_alert.py",
            "tests/test_ui_app_helpers.py",
            "tests/test_login_controller_service.py",
            "tests/test_login_controller.py",
            "tests/test_login_runtime_events.py",
            "tests/test_mediacrawler_login_runtime.py",
            "tests/test_mediacrawler_qr.py",
            "tests/test_mediacrawler_phone.py",
            "tests/test_mediacrawler_runtime.py",
